...
public class KeranjangAdapter1 extends RecyclerView.Adapter<KeranjangAdapter1.ItemViewHolder> {
    ...
    public KeranjangAdapter1(Context context, List<Pesanan> exampleItems){
...
//        holder.mUsername.setText(user[0]);
        ...
        holder.cardViewPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent kk = new Intent(mContext, KonfirmasiPembayaran.class);
