...
public class KeranjangAdapter extends RecyclerView.Adapter<KeranjangAdapter.ItemViewHolder> {
...
//            mStatusPesanan = itemView.findViewById(R.id.tv_statuspesan);
    ...
    public KeranjangAdapter(Context context, List<Pesanan> exampleItems){
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_keranjang,parent,false);
