...
public class ItemUserListAdapter extends RecyclerView.Adapter<ItemUserListAdapter.ItemViewHolder> {
    ...
    public ItemUserListAdapter(Context context, ArrayList<Item2> exampleItems){
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (position){
                    ...
                    case 2:
                        Intent intent2 = new Intent(mContext, ProfilUser.class);
